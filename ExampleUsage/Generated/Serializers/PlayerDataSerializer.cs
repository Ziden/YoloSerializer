    ...
    public sealed class PlayerDataSerializer : ISerializer<YoloSerializer.Core.Models.PlayerData?>
    {
        ...
        public int GetSize(YoloSerializer.Core.Models.PlayerData? playerData)
        {
            ...
            size += Int32Serializer.Instance.GetSize(playerData.PlayerId);
                        ...
                        size += (playerData.Achievements == null ? sizeof(int) : Int32Serializer.Instance.GetSize(playerData.Achievements.Count) + playerData.Achievements.Sum(listItem => StringSerializer.Instance.GetSize(listItem)));
                        size += (playerData.Stats == null ? sizeof(int) : Int32Serializer.Instance.GetSize(playerData.Stats.Count) + playerData.Stats.Sum(kvp => StringSerializer.Instance.GetSize(kvp.Key) + Int32Serializer.Instance.GetSize(kvp.Value)));
